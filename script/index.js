...
let form = document.querySelector('.picture__popup__form')
let picture = document.querySelector('.picture')
let OpenPicture = document.querySelector('.profile__button')
let closePicture = document.querySelector('.picture__popup__button')
let CardContent = document.querySelector('.card-template');
let namePicture = document.querySelector('.picture__popup__input_type_name')
let jobPicture = document.querySelector('.picture__popup__input_type_job')
